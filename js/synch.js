$(document).ready(function() {
	...
	//720p playback
	$("#play-videoshd720").click(function(){
		playVideosHD720('aDorTBEhEtk' , 'ihv4f7VMeJw');
	});

	function playVideosHD720(url1, url2){
		"use strict";
		$(".videos").html('<object><param name="movie" value="https://www.youtube.com/v/'+url1+'?autoplay=1&loop=1&rel=0&vq=hd720"></param><param name="wmode" value="transparent"></param><param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param><embed src="https://www.youtube.com/v/'+url1+'?autoplay=1&loop=1&rel=0&vq=hd720" type="application/x-shockwave-flash" allowscriptaccess="always" wmode="transparent" allowfullscreen="true"></embed></object><object><param name="movie" value="https://www.youtube.com/v/'+url2+'?autoplay=1&loop=1&rel=0&vq=hd720&wmode=transparent"></param><param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param><embed src="https://www.youtube.com/v/'+url2+'?autoplay=1&loop=1&rel=0&vq=hd720&wmode=transparent" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true"></embed></object>');
	};
